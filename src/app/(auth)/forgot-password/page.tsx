...
export default function ForgotPasswordPage() {
  ...
  function onSubmit(values: ForgotPasswordInput) {
    if (forgotPasswordMutation.isPending || countdown > 0) return
    ...
    <div className='min-h-screen bg-background flex items-center justify-center p-4'>
      <div className='w-full max-w-md bg-card p-8 rounded-lg border border-border shadow-sm'>
        <div className='mb-8'>
          ...
          <p className='text-muted-foreground text-sm mt-2'>Nhập email của bạn để nhận hướng dẫn đặt lại mật khẩu.</p>
        </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-5'>
            ...
            <Button
              ...
              className='w-full bg-primary text-primary-foreground rounded-md py-6 text-base font-bold hover:bg-primary/90 transition-all active:scale-[0.98] tabular-nums'
            >
