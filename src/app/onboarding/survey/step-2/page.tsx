...
const TECHNOLOGIES = [
  ...
  { id: 'rust', name: 'Rust', icon: 'https://cdn.worldvectorlogo.com/logos/rust.svg' },
  {
    id: 'vuejs',
    name: 'Vue.js',
    icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzcT2qdg7hhXLOX4srNBB0PNhgyXGE8_qT1w&s'
  },
...
export default function OnboardingStep2() {
  ...
  const handleToggleTech = (tech: string) => {
    setData((prev) => ({
      ...prev,
      techs: prev.techs.includes(tech) ? prev.techs.filter((t) => t !== tech) : [...prev.techs, tech]
    }))
  }
  ...
  return (
    <>
      <OnboardingHeader step={2} totalSteps={6} progress={(2 / 6) * 100} />
        ...
        <div className='animate-in fade-in slide-in-from-bottom-4 duration-700'>
          <div className='flex flex-col items-center w-full max-w-4xl mx-auto'>
            <div className='text-center mb-8 mt-8'>
              ...
              <p className='text-muted-foreground'>Chọn ít nhất một công nghệ để bắt đầu hành trình của bạn.</p>
            </div>
