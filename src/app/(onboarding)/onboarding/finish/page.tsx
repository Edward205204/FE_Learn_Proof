    ...
    <div className="min-h-screen bg-[#FFF5F7]">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center justify-between">
            <p className="text-muted-foreground max-w-xl">
              Dựa trên mục tiêu và kỹ năng hiện tại, chúng tôi đã thiết kế hành trình học tập tối ưu nhất dành riêng cho bạn. Kiểm tra và tùy chỉnh theo ý muốn.
            </p>
            <div className="flex gap-3">
              <Button variant="outline" className="rounded-2xl border-rose-100 bg-white shadow-sm hover:bg-rose-50 text-rose-500 font-bold">
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    <div className="flex gap-2">
                      {step.tags.map(tag => (
                        <Badge key={tag} variant="secondary" className="bg-rose-50 text-rose-400 border-none font-bold text-[10px] px-2">
                          {tag}
                        </Badge>
                      ))}
                    </div>
            ...
            <div className="bg-white rounded-[40px] p-8 shadow-2xl shadow-rose-100 border border-white">
              ...
              <div className="space-y-4 mb-8">
                {currentStepData.lessons.map((lesson) => (
                  <div key={lesson.id} className="flex items-center gap-4 p-4 rounded-3xl bg-rose-50/50 hover:bg-rose-50 border border-transparent hover:border-rose-100 transition-all cursor-pointer">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[10px] font-black text-muted-foreground uppercase">
                        {lesson.type === 'video' ? 'VIDEO' : lesson.type === 'doc' ? 'TÀI LIỆU' : 'TRẮC NGHIỆM'} • {lesson.duration}
                      </p>
                    </div>
      ...
      <footer className="max-w-6xl mx-auto px-6 py-12 flex items-center justify-between border-t border-rose-100 mt-12 mb-8">
        ...
        <div className="flex gap-8">
          <a href="#" className="text-sm font-bold text-muted-foreground hover:text-primary transition-colors">Hướng dẫn</a>
          <a href="#" className="text-sm font-bold text-muted-foreground hover:text-primary transition-colors">Hỗ trợ học tập</a>
          <a href="#" className="text-sm font-bold text-muted-foreground hover:text-primary transition-colors">Cộng đồng</a>
        </div>
      </footer>
    </div>
  );
