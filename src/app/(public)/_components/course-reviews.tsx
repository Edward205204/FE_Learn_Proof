...
import {
  ...
  useLearnerReplyToReviewMutation
} from '@/app/(learner)/_hooks/use-course'
  ...
  const handleEdit = (review: CourseReview) => {
    ...
    window.scrollTo({
      top: document.getElementById('review-form')?.offsetTop
        ? document.getElementById('review-form')!.offsetTop - 100
        : 0,
      behavior: 'smooth'
    })
  }
          ...
          reviews.map((review) => (
            ...
            >
              ...
              <div className='relative'>
                <p className='text-slate-600 dark:text-slate-400 font-medium leading-[1.7]'>{review.comment}</p>
                            ...
                            <div className='flex items-center gap-2'>
                              ...
                              <p className='text-[10px] font-black text-slate-500'>
                                ...
                                <span className='text-slate-400 font-medium ml-1'>
                                  ·{' '}
                                  {review.learnerReplyAt
                                    ? format(new Date(review.learnerReplyAt), 'dd MMMM, yyyy', { locale: vi })
                                    : ''}
                                </span>
                              </p>
                            </div>
