      ...
      <div className='bg-gradient-to-r from-primary/10 via-primary/5 to-transparent dark:from-muted/50 dark:to-transparent w-full h-[240px] relative border-b border-border'>
        <div className='max-w-6xl mx-auto h-full flex items-center px-6 md:px-0 relative'>
          <div className='space-y-3'>
            <h5 className='text-[12px] font-bold text-muted-foreground uppercase tracking-widest'>LEARNER</h5>
            <h1 className='text-4xl md:text-5xl font-bold text-foreground tracking-tight'>Mạnh Cường Trương</h1>
          </div>
            ...
            {purchasedCourses.map((course) => (
              ...
              >
                ...
                <div className='p-6 pt-5 flex flex-col flex-1'>
                  ...
                  <p className='text-[13px] font-medium text-muted-foreground flex-1'>{course.instructor}</p>
                </div>
              </div>
            ))}
          </div>
