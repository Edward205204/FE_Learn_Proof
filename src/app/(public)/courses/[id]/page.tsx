              ...
              {courseData.overallAnalytics && (
                <div className='flex items-center gap-2'>
                  ...
                  <span className='text-xs text-slate-400 font-bold'>
                    ({courseData.overallAnalytics.totalStudents.toLocaleString()} học viên)
                  </span>
                </div>
              )}
            </div>
          ...
          <section>
            ...
            <div className='space-y-4'>
              {courseData.chapters.map((chapter) => (
                <div
                  key={chapter.id}
                  className='bg-white dark:bg-slate-900 rounded-[2rem] overflow-hidden border border-slate-100 dark:border-slate-800 transition-all shadow-sm'
                >
                  <button
                  ...
                  >
                    <span className='text-base font-black text-slate-900 dark:text-white'>{chapter.title}</span>
                    <ChevronDown
                      size={20}
                      className={cn(
                ...
                <div className='space-y-5'>
                  ...
                  <div className='space-y-4'>
                    ...
                    <FeatureItem
                      ...
                      text={`${courseData.publishedLessonsCount} Bài giảng`}
                    />
