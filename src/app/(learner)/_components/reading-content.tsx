  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='bg-background rounded-xl border border-border shadow-sm overflow-hidden'>
        ...
        {/* Nội dung bài đọc */}
        <div
          className='px-10 py-8 text-[15px] leading-[1.9] prose prose-cyan max-w-none dark:prose-invert prose-p:text-foreground/90 prose-headings:text-foreground prose-a:text-primary hover:prose-a:text-primary/80'
