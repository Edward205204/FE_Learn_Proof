    ...
    <div className="min-h-screen bg-[oklch(0.98_0.005_286.32)] dark:bg-[oklch(0.12_0.005_285.823)] flex flex-col items-center justify-center py-16 px-6">
      <div className="container max-w-[850px] flex flex-col items-center">
        ...
        <div className="w-full bg-white dark:bg-[oklch(0.141_0.005_285.823)] rounded-[60px] p-12 md:p-20 shadow-2xl shadow-[oklch(0.141_0.005_285.823)]/5 flex flex-col items-center text-center relative overflow-hidden">
          ...
          <div className="w-full max-w-xl bg-[oklch(0.577_0.245_27.325)]/5 dark:bg-[oklch(0.577_0.245_27.325)]/10 rounded-3xl p-8 mb-12 text-left border border-[oklch(0.577_0.245_27.325)]/10 relative">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
              <div>
                <p className="text-[10px] uppercase tracking-widest font-black text-[oklch(0.552_0.016_285.938)] mb-2">Khóa học</p>
            ...
            <div className="grid grid-cols-2 gap-8 pt-6 border-t border-[oklch(0.577_0.245_27.325)]/20">
              <div>
                <p className="text-[10px] uppercase tracking-widest font-black text-[oklch(0.552_0.016_285.938)] mb-1.5">Mã giao dịch</p>
                <p className="font-bold text-gray-900 dark:text-white">#LP-12345678</p>
              </div>
              <div>
                <p className="text-[10px] uppercase tracking-widest font-black text-[oklch(0.552_0.016_285.938)] mb-1.5">Ngày thanh toán</p>
          ...
          <div className="flex flex-col sm:flex-row gap-5 w-full max-w-md">
            <Button asChild className="flex-1 h-16 bg-[oklch(0.577_0.245_27.325)] hover:bg-[oklch(0.477_0.245_27.325)] text-white gap-2 rounded-2xl font-black text-lg shadow-lg shadow-[oklch(0.577_0.245_27.325)]/20 transition-all active:scale-[0.98]">
              <Link href={PATH.MY_COURSES}>
                Bắt đầu học ngay <ArrowRight size={20} />
              </Link>
            </Button>
            <Button variant="outline" className="flex-1 h-16 border-slate-200 dark:border-slate-800 text-gray-900 dark:text-white rounded-2xl font-black text-lg gap-2 hover:bg-slate-50 dark:hover:bg-slate-900 transition-all">
              <Download size={20} />
              Tải hóa đơn
            </Button>
          </div>
        ...
        <div className="mt-20 w-full text-center">
          <p className="text-[10px] uppercase tracking-[0.4em] font-black text-[oklch(0.552_0.016_285.938)] mb-12">Các bước tiếp theo</p>
        ...
        <div className="mt-20 opacity-30">
          <p className="text-lg font-black tracking-tighter text-[oklch(0.141_0.005_285.823)] dark:text-white grayscale">LearnProof</p>
        </div>
      </div>
    </div>
  );
