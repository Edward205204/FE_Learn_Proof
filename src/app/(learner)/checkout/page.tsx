          ...
          <div className="lg:w-[62%] flex flex-col gap-10">
            ...
            <section>
              <div className="flex items-center gap-3 mb-6">
                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[oklch(0.577_0.245_27.325)] text-white text-sm font-black">1</div>
                <h2 className="text-xl font-bold text-[oklch(0.141_0.005_285.823)] dark:text-white">Phương thức thanh toán</h2>
              </div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-6">
                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[oklch(0.577_0.245_27.325)] text-white text-sm font-black">2</div>
          ...
          <div className="lg:w-[38%] flex flex-col gap-6">
            <div className="bg-white dark:bg-[oklch(0.141_0.005_285.823)] p-8 rounded-[40px] border border-transparent dark:border-[oklch(0.274_0.006_286.033)] shadow-xl shadow-slate-200/50 dark:shadow-none relative overflow-hidden">
              ...
              <div className="flex gap-5 mb-8">
                <div className="w-24 h-24 rounded-3xl overflow-hidden shrink-0 border border-slate-100 dark:border-slate-800 shadow-sm">
                  <img 
                ...
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white leading-tight line-clamp-2 mb-1.5">
                    Kỹ thuật Biên tập Nội dung Chuyên sâu
                  </h3>
                  <p className="text-xs text-[oklch(0.552_0.016_285.938)] font-medium">Khóa học Premium</p>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex justify-between text-sm font-medium">
                  ...
                  <span className="text-gray-900 dark:text-white line-through">1.250.000đ</span>
                </div>
                <div className="flex justify-between text-sm font-black">
                  <span className="text-[oklch(0.45_0.1_160)]">Ưu đãi (Săn học bổng)</span>
                  <span className="text-[oklch(0.45_0.1_160)]">-450.000đ</span>
                </div>
              </div>
              ...
              <div className="border-t border-slate-100 dark:border-slate-800 pt-6 mb-10">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-4xl font-black text-[oklch(0.577_0.245_27.325)]">800.000đ</span>
                </div>
              </div>

              {/* Checkout Button */}
              <Button asChild className="w-full h-16 bg-[oklch(0.577_0.245_27.325)] hover:bg-[oklch(0.477_0.245_27.325)] text-white gap-2 rounded-3xl font-black text-lg shadow-lg shadow-[oklch(0.577_0.245_27.325)]/20 transition-all active:scale-[0.98]">
                <Link href={PATH.CHECKOUT_SUCCESS}>
            ...
            <div className="bg-white dark:bg-[oklch(0.141_0.005_285.823)] p-6 rounded-3xl border border-transparent dark:border-[oklch(0.274_0.006_286.033)] shadow-md flex items-center justify-between group cursor-pointer hover:border-[oklch(0.577_0.245_27.325)]/30 transition-all">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[oklch(0.552_0.016_285.938)] font-bold">Chúng tôi luôn sẵn sàng 24/7</p>
                </div>
              </div>
              <ChevronRight size={18} className="text-slate-300 group-hover:text-[oklch(0.577_0.245_27.325)] group-hover:translate-x-1 transition-all" />
            </div>
          </div>
        </div>
      </div>
