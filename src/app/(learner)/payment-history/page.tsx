...
const MOCK_TRANSACTIONS = [
    { id: '1', orderCode: '#LP-9921', courseName: 'React Native Masterclass', amount: 1200000, paymentDate: '15 Th10, 2023', paymentMethod: 'MoMo', status: 'SUCCESS' },
    { id: '2', orderCode: '#LP-8842', courseName: 'UI/UX Design Fundamentals', amount: 850000, paymentDate: '10 Th10, 2023', paymentMethod: 'Thẻ ngân hàng', status: 'SUCCESS' },
    { id: '3', orderCode: '#LP-7731', courseName: 'Advanced Python Scripting', amount: 2100000, paymentDate: '05 Th10, 2023', paymentMethod: 'Crypto', status: 'PENDING' },
];
        ...
        <div className="max-w-7xl mx-auto p-6 md:p-10 space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button variant="outline" className="rounded-2xl border-slate-100 h-[46px] px-5 gap-2 font-bold text-slate-600">
                        <Filter size={18} /> Lọc
                    </Button>
                </div>
            </div>
                ...
                <div className="flex gap-2">
                    {[1, 2, 3, '...', 9].map((p, i) => (
                        <button key={i} className={cn(
                            ...
                            p === 1 ? "bg-primary text-white shadow-lg shadow-rose-200" : "bg-white text-slate-500 hover:bg-slate-50"
                        )}>
                            {p}
                        </button>
                    ))}
            ...
            <div className="bg-slate-50/50 rounded-3xl p-6 border border-slate-100 flex items-start gap-4">
                ...
                <div className="text-sm text-slate-600 leading-relaxed">
                    Bạn có thắc mắc về các giao dịch? Vui lòng liên hệ <span className="font-bold text-primary cursor-pointer hover:underline">Trung tâm hỗ trợ</span> hoặc gửi email đến <span className="font-bold text-slate-900">billing@learnproof.edu.vn</span> để được giải quyết nhanh nhất.
                </div>
            </div>
        </div>
    )
