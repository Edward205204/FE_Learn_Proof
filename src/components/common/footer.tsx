...
export default function Footer() {
  return (
    <footer
      className='border-t bg-white px-6 py-12 md:px-10 
    ...
    >
      <div className='mx-auto grid max-w-[1200px] grid-cols-1 gap-10 md:grid-cols-4'>
        ...
        <div>
          ...
          <ul className='flex flex-col gap-2 text-sm text-[oklch(0.552_0.016_285.938)]'>
            <li>
              <a className='hover:text-[oklch(0.577_0.245_27.325)] transition-colors' href='#'>
                All Courses
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <p className='mb-4 text-sm text-[oklch(0.552_0.016_285.938)]'>Get the latest updates and course offers.</p>
      ...
      <div
        className='mx-auto mt-12 max-w-[1200px] border-t pt-8 text-center text-xs text-[oklch(0.552_0.016_285.938)]
        border-[oklch(0.92_0.004_286.32)] dark:border-[oklch(0.274_0.006_286.033)]'
      >
